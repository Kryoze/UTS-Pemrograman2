...
import uts.project.LoginMhs;
import uts.project.About;
import uts.project.TableMhs;
...
public class MenuMhs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Alfian Bayu Nur Aji - Menu Utama");
        setBackground(java.awt.SystemColor.info);
        setResizable(false);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jLabel1.setText("Aplikasi Database Mahasiswa");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 280, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uts/project/logo (2).png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uts/project/milky-way-2695569_1280.jpg"))); // NOI18N
